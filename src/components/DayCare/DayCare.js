...
//   const [showRejected, setShowRejected] = useState(false); // State for tracking rejected requests
...
//   const rejectedRequests = products.filter(
...
//         {showRejected ? "Show All Requests" : "Show Rejected Requests"}
//       </button>
...
//           <TableBody>
//             {showRejected
//               ? rejectedRequests.map((product, index) => (
//                   <TableRow key={index}>
